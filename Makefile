all:spiderclient.pyc parserserver.pyc parser.pyc spider.pyc store.pyc DataStore.pyc
	...
	cp src/DataStore.pyc knownledgelib
...
DataStore.pyc:src/DataStore.py
	python -m compileall src/DataStore.py
clean:
